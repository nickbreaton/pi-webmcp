...
@extensions/pi-webmcp.ts will be loaded by Pi as an extension so we can test, but also familiarize yourself with its contents as we may want to modify it.
